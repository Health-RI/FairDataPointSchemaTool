...
public record SettingsRequestDto(
    ...
    public record Ping(boolean enabled, List<String> endpoints, List<String> endpointsFromConfig, String interval) {}
    public record Repository(String type) {}
    public record Search(List<String> filters) {}
    public record Forms(Autocomplete autocomplete) {
        public record Autocomplete(boolean searchNamespace, List<Source> sources) {
